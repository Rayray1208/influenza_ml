...
# 使用最佳参数创建模型
best_params = {'reg_lambda': 0.1, 'reg_alpha': 1, 'n_estimators': 700, 'min_child_weight': 9, 'max_depth': 10, 'learning_rate': 0.2, 'gamma': 0.3}
...
predicted_value_averagetemperature = predict_new_value_atp(year_week_input)
print(f"AverageTemperature为: {predicted_value_averagetemperature:.2f}")